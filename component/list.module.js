var app = angular.module('List', ['ListComponent']);
...
app.controller('MainController', ['$scope', function($scope) {
    console.log("this is main controller");
        $scope.list = [
            ...
            {
                url: 'https://tutorialzine.com/2013/07/50-must-have-plugins-for-extending-twittter-bootstrap/',
            ...
            {
                url: 'https://tutorialzine.com/2013/84/services-chooser-backbone-js/', 
